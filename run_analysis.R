...
# - all columns representing an euclidean norm (containing the string 'Mag')
...
# exclude the meanFreq and Mag columns from previous result
match<-grep("meanFreq|Mag", mean_std_features$V2, invert=TRUE)
